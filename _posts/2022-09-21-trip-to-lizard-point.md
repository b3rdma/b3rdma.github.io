---
layout: post
title: Trip to Lizard Point
date: 2022-09-21
author: b3rdma
description: A family trip to Lizard Point in Cornwall, with dramatic skies, wildlife and plenty of coastal scenery.
categories:
  - Personal
  - Travel
tags:
...
![Crazy Family](lizard-point-family.jpeg){: width="700" height="400" }
_Family on way to cafe_
...
{% include embed/youtube.html id='8nd9fb3bwis' %}
_Sweet little bird at the cafe_

![Zed and Yasmin having a coffee break](lizard-point-yassi.jpeg){: width="700" height="400" }
_Lovebirds at the cafe_
...
![Calm seas at Lizard Point](lizard-point-1.jpeg){: width="700" height="400" }
_Calm waters by the old Lifeboat station_
...
{% include embed/youtube.html id='Cva5OUZefzA' %}
_Waves crashing against the rocks_

After the coffee we were blessed with the slow appearance of the sun. It required some encouragement to break through the clouds but it made it. As Yasmin and I were perusing in the little art shop, Fred and the folks decided to chill on the bench _(no space for Dad on the bench; hopefully he didn't catch any crabs sat there!!)_ and bask in the little warmth that the sun bestowed upon them.

![The crazies at Lizard Point](lizard-point-crazies.jpeg){: width="700" height="400" }
_The crazies_
...
{% include embed/youtube.html id='WFsMzra2vw0' %}
_Sweet little bird_
...
![Gull over the sea](lizard-point-gull-water.jpeg){: width="700" height="400" }
_Gull hovering over the cold moody sea_

![Lizard Point landscape](lizard-point-stunning-colours.jpeg){: width="700" height="400" }
_Stunning palette of colour along the coastline_
...
![Fred, Mum and Dad on cliff](lizard-point-fred-folks.jpeg){: width="700" height="400" }
_Fred, Mum and Dad chilling on a cliff_

_There are rumours of a mysterious healing hand; when one sits on a cliff at Lizard Point and meditates, the hand hovers over you and cleanses your soul._ But that could be a load of bollocks.

![The healing hand](lizard-point-healing-hand.jpeg){: width="700" height="400" }
_The mysterious healing hand!!_

Final photo of the post, as will often be, is of the lovers _extraordinaire_.

![Lovers](lizard-point-yassi-me.jpeg){: width="700" height="400" }
_Endless love in an endless landscape_
